...
export default {
    ...
    lt: {
        ...
        aboutMe: {
            title: "Apie Mane",
            text: "Aš esu full-stack žiniatinklio programuotojas, besidomintis svetainių ir web aplikacijų kūrimu. Aš specializuojuosi JavaScript ir PHP, bei turiu patirties dirbant su React.js. Man taip pat patinka išbandyti naujas technologijas. Šiuo metu savarankiškai tobulinu programavimo žinias.",
        },
        education: {
